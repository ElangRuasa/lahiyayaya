...
document.getElementById("loveIn").onclick = async function() {
    if (sudahKlik) {
        ...
        //setTimeout(function(){
	        ...
	        const popups = [
		        { teks: "hallo sahabat quh", stiker: stikerPopup1.src, waktu: 2200 },
		        { teks: "jujur nih ye gw mau nanya sebenrnya", stiker: stikerPopup2.src, waktu: 2200 },
		        { teks: "tapi lu jangan kaget ya", stiker: stikerPopup3.src, waktu: 2200 },
		        { teks: "Sebenernya...", stiker: stikerPopup4.src, waktu: 2200 },
		    ];
		
		    for (const popup of popups) {
		        await tampilPopup(popup.teks, popup.stiker, popup.waktu);
		    }
